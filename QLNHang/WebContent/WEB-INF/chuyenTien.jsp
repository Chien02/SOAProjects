		...
		<table class="masterTable">
			<thead>
				<tr>
					...
					<th class="functionTHead"><h3>CHUYEN TIEN</h3></th>
				</tr>
			</thead>
			<tbody>
				<tr>
					...
					<td rowspan="8" class="merged-cell">
						<form action="QLNHangWebClient?action=chuyentien" method="POST">
							<table class="functionTable">
								...
								<tbody>
									...
									<tr>
										<td><label>So tai khoan nhan: </label></td>
										<td><input type="text" name="soTKNhan" required></td>
									</tr>
									<tr>
										<td><label>So tien muon chuyen: </label></td>
									...
									<tr>
										<td colspan="2" style="text-align: center; padding: 5px;"><button type="submit">CHUYEN TIEN</button></td>
									</tr>
								</tbody>
							</table>
						</form>
