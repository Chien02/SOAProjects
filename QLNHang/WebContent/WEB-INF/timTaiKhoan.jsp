    ...
    <table class="masterTable">
        <thead>
            <tr>
                ...
                <th class="functionTHead"><h3>TIM TAI KHOAN</h3></th>
            </tr>
        </thead>
        <tbody>
            <tr>
                ...
                <td rowspan="8" style="vertical-align: top;">
                    <form action="QLNHangWebClient?action=timtaikhoan" method="POST" class="formTimTaiKhoan">
                        <table class="functionTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><label>Nhap so tai khoan:</label></td>
                                    <td>
                                    	<input type="text" name="soTK" required>
	                                    <button type="submit">TIM</button>
                                    </td>
                                    
                                    <c:if test="${not empty tkCanTim}">
                                		<tr>
                                			<td><p>So tai khoan:</p></td>
                                			<td>${tkCanTim.soTaiKhoan}</td>
                                		</tr>
                                		<tr>
                                			<td><p>Chu tai khoan:</p></td>
                                			<td>${tkCanTim.chuTaiKhoan}</td>
                                		</tr>
                                		<tr>
                                			<td><p>So du:</p></td>
                                			<td>${tkCanTim.soDu}</td>
                                		...
                                		<tr>
                                			...
                                			<td>
                                				<c:if test="${tkCanTim.laAdmin}">Co</c:if>
                                				<c:if test="${not tkCanTim.laAdmin}">Khong</c:if>
                                			</td>
                                		</tr>
                                	</c:if>
                                </tr>
