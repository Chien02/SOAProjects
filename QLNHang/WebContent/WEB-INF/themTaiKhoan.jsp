    ...
    <table class="masterTable">
        <thead>
            <tr>
                ...
                <th class="functionTHead"><h3>THEM TAI KHOAN</h3></th>
            </tr>
        </thead>
        <tbody>
            <tr>
                ...
                <td rowspan="8" style="vertical-align: top;">
                    <form action="QLNHangWebClient?action=themtaikhoan" method="POST" class="formThemTaiKhoan">
                        <table class="functionTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><label>So tai khoan:</label></td>
                                    <td><input type="text" name="soTK" required></td>
                                </tr>
                                <tr>
                                    <td><label>Chu tai khoan:</label></td>
                                    <td><input type="text" name="chuTK" required></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="2" style="color: red; text-align: center;">${thongBaoSaiMaPin}</td>
                                </tr>
                                <tr>
                                    <td><label>Xac nhan lai ma PIN:</label></td>
                                    <td><input type="password" name="maPinRepeat" required></td>
                                </tr>
                                <tr>
                                    <td><label for="laAdmin">La Admin:</label></td>
                                    <td>
                                        <input type="checkbox" id="laAdmin" name="laAdmin" value="true">
                                    </td>
                                </tr>
                                <tr>
