		...
		<table class="masterTable">
			<thead>
				<tr>
					...
					<th class="functionTHead"><h3>RUT TIEN</h3></th>
				</tr>
			</thead>
			<tbody>
				<tr>
					<td> <a href="QLNHangWebClient?action=thongtin">THONG TIN</a> </td>
					<td rowspan="7" class="merged-cell">
						<form action="QLNHangWebClient?action=ruttien" method="POST">
							<table class="functionTable">
								...
								<tbody>
									...
									<tr>
										<td><label>So tien muon rut: </label></td>
									...
									<tr>
										<td colspan="2" style="text-align: center; padding: 5px;"><button type="submit">RUT TIEN</button></td>
									</tr>
								</tbody>
							</table>
						</form>
